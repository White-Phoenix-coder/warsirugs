(function ($) {
  ...
  // Date Picker
  if ($(".warsi-datepicker").length) {
    $(".warsi-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  if ($(".sticky-header").length) {
    $(".sticky-header")
      ...
      .insertAfter(".sticky-header")
      .addClass("sticky-header--cloned")
      .find(".logo-text img")  // Target the logo image in the cloned header
      .attr("src", "images/logo-red-300px.jpg");  // Update the source of the logo
  }
  ...
  //accrodion
  if ($(".warsi-accrodion").length) {
    var accrodionGrp = $(".warsi-accrodion");
  ...
  function thmOwlInit() {
    // owl slider
    let warsiowlCarousel = $(".warsi-owl__carousel");
    if (warsiowlCarousel.length) {
      warsiowlCarousel.each(function () {
        let elm = $(this);
    ...
    let warsiowlCarouselNav = $(".warsi-owl__carousel--custom-nav");
    if (warsiowlCarouselNav.length) {
      warsiowlCarouselNav.each(function () {
        let elm = $(this);
  ...
  //Strech Column
  function warsi_stretch() {
    var i = $(window).width();
    $(".row .warsi-stretch-element-inside-column").each(function () {
      var $this = $(this),
...
images.forEach((img, index) => {
    img.addEventListener("click", function () {
        ...
        currentIndex = index; // Set currentIndex to the clicked image's index
    });
});
...
// Change image (next and previous)
function changeImage(direction) {
    ...
    modalImg.src = images[currentIndex].src; // Update modal image source
}
